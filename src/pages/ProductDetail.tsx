...
export default function ProductDetail() {
    ...
    const addToCart = (product: Product) => {
        ...
        const cart = raw ? JSON.parse(raw) : { state: { items: [] }, version: 0 };

        const updatedItems = [...cart.state.items, product];
        const updatedCart = {
          ...cart,
          state: { items: updatedItems }
        };
    
        localStorage.setItem("cozy-cart", JSON.stringify(updatedCart));
    }; 
          ...
          <div className="max-w-5xl mx-auto p-6 grid md:grid-cols-2 gap-8 mt-5">
            ...
            <div>
              ...
              <div className="flex gap-3">
                  <button className="rounded-lg bg-orange-300 hover:bg-orange-400 px-5 py-2 cursor-pointer" onClick={() => addToCart(product)}>
